...
class PoetsControllerTest < ActionController::TestCase
  ...
  test "should create poet" do
    assert_difference('Poet.count') do
      post :create, poet: { display_name: @poet.display_name, email: @poet.email, first_name: @poet.first_name, last_name: @poet.last_name, passwordhash: @poet.passwordhash }
    end
  ...
  test "should update poet" do
    patch :update, id: @poet, poet: { display_name: @poet.display_name, email: @poet.email, first_name: @poet.first_name, last_name: @poet.last_name, passwordhash: @poet.passwordhash }
    assert_redirected_to poet_path(assigns(:poet))
  end
